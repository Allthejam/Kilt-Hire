...
export const INITIAL_ITEMS: KiltItem[] = [
  {
    id: 'BIN-SGIAN-DUBH',
    name: 'Master Sgian-dubh Storage Bin',
    category: 'Sgian-dubh (Knife)',
    sizeGroup: 'Adult',
    tartanOrColour: 'Highland Silver & Imitation Staghorn',
    size: 'Standard Bulk Bin',
    hireRate: 8,
    depositAmount: 10,
    status: 'AVAILABLE',
    isBulkPool: true,
    bulkQuantity: 142,
    bulkTotal: 150,
    registeredAt: '2026-06-01 09:00'
  },
  {
    id: 'BIN-KILT-PINS',
    name: 'Master Kilt Pins Storage Bin',
    category: 'Miscellaneous',
    sizeGroup: 'Adult',
    tartanOrColour: 'Celtic Cross & Thistle Silver',
    size: 'Standard Bulk Bin',
    hireRate: 5,
    depositAmount: 5,
    status: 'AVAILABLE',
  ...
  {
    id: 'BIN-BELTS-BUCKLES',
    name: 'Master Belts & Buckles Storage Bin',
    category: 'Belts & Buckles',
    sizeGroup: 'Adult',
    tartanOrColour: 'Black Leather with Chromed Celtic Buckle',
    size: 'Standard Bulk Bin',
    hireRate: 8,
    depositAmount: 10,
    status: 'AVAILABLE',
  ...
  {
    id: 'BIN-GARTERS',
    name: 'Master Socks & Garters Storage Bin',
    category: 'Socks & Garters',
    sizeGroup: 'Adult',
    tartanOrColour: 'Cream & Red Highland Garter Flashes',
    size: 'Standard Bulk Bin',
    hireRate: 5,
    depositAmount: 5,
    status: 'AVAILABLE',
